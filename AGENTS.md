# Paste-an-ICS, get one-tap add-to-calendar links (iPhone-safe) (`ics-to-phone-calendar`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://ics-to-phone-calendar.sociobot.in`. Artifact class: `static-web`.
